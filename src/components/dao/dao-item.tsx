...
import { formatKST } from '@/utils/timezone';
  ...
  return (
    <div className="flex flex-col gap-4 py-8 md:gap-6 lg:flex-row lg:gap-10">
          ...
          <div className="lg:w-[70%]">
            <div className="flex w-full items-center justify-between gap-4">
              ...
              <Typography level="body2" className="text-medium text-white">
                {startAt
                  ? formatKST(startAt, 'YYYY-MM-DD | HH:mm:ss')
                  : 'N/A'}
              </Typography>
            </div>
            <div className="flex w-full items-center justify-between gap-4">
              ...
              <Typography level="body2" className="text-medium text-white">
                {endAt ? formatKST(endAt, 'YYYY-MM-DD | HH:mm:ss') : 'N/A'}
              </Typography>
            </div>
          </div>
      ...
      <div className="flex-1">
        ...
        <Tabs className="rounded-xl bg-[#FFFFFF0A]" defaultValue="quest">
          <TabsList className="w-full justify-start gap-4 border-b border-border px-5">
            <TabsPrimitive.Trigger
              className={cn(
                'inline-flex items-center justify-center whitespace-nowrap rounded-tl-xl rounded-tr-xl px-1 pb-2 pt-4 border-b-[2px] border-transparent ring-offset-background transition-all',
