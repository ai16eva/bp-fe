...
export const DAOContainer = () => {
  ...
  return (
    <div className="px-6">
      <div className="app-container rounded-t-8 bg-background py-5 md:rounded-t-12 md:p-10 lg:rounded-t-14 lg:p-14 xl:p-16">
        <DAOToolbar
  ...
  return (
    <div className="mb-8 flex items-center justify-between border-b border-dashed border-border pb-6 xl:pb-9">
      <div className="flex flex-1 items-center gap-2">
        <Typography level="h3" className="text-2xl font-semibold">
          {status === 'draft' && 'Draft'}
        ...
        <div className="flex items-center gap-4">
          {filterDAOQuestsOptions.map((option) => (
            <Button
              key={option.value}
              variant="outline"
              className="w-[107px] h-11 px-5 py-3 rounded-[10px] border-foreground text-foreground dark:bg-[#006FBC] dark:border-[#006FBC] font-outfit font-normal text-base leading-[100%]"
